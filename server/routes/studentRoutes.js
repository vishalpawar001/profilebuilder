...
const {  getAllStudents, getStudentByName, studentLogin,
    updatePassword, forgotPassword, getStudentByRegName,
    postOTP,  updateProfile, getAllSubjects, getMarks ,StudentAddSkill} = require('../controller/studentController')
// const { default: StudentAddSkill } = require('../../client/src/Pages/StudentAddSkill')
...
router.post('/StudentAddSkill', passport.authenticate('jwt', { session: false }), StudentAddSkill)    
