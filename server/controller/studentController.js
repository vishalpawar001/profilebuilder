...
module.exports = {
    ...
    StudentAddSkill: async (req, res, next) => {
        // console.log(req);
    
      const {registrationNumber, skill  ,avatar,department}=req.body;
      console.log(registrationNumber,skill,avatar,department);
    //   console.log(req.file);
      
    cloudinary.uploader.upload(avatar, function(error, result) {console.log(result, error)});
    ...
    //   console.log();
      const faculty = await Faculty.findOne({ department });
    
    //   const avatars= imgResponse.secure_url
      const skill1 = {
          skill,
          avatar,
          registrationNumber
      ...
      faculty.skillApprovalReq.push(skill1);
      

      await faculty.save();

    //   const a = Faculty.findOne({});
    //   console.log(a.skillApprovalReq);
     
    //   const arr = Faculty.find({department:department});
    //   console.log(arr);
    // const arr=Skill.find({});
    // console.log(arr);
